  ...
  var altCaption = ['first','second','third','fourth','fifth',
  'sixth','seventh','eightth','nine','tenth','eleventh',
  'twelveth','thirteen','fourteen','fifteen','sixteen'];

  var birdAltCaption = ['bird 1','bird 2','bird 3','bird 4',
  'bird 5','bird 6','bird 7','bird 8','bird 9','bird 10',
  'bird 11','bird 12','bird 13','bird 14','bird 15','bird 16'];

  var dogAltCaption = ['dog 1','dog 2','dog 3','dog 4','dog 5',
  'dog 6','dog 7','dog 8','dog 9','dog 10',
  'dog 11','dog 12','dog 13','dog 14','dog 15','dog 16'];

  var dolphinAltCaption = ['dolphin 1','dolphin 2','dolphin 3',
  'dolphin 4','dolphin 5','dolphin 6','dolphin 7','dolphin 8',
  'dolphin 9','dolphin 10','dolphin 11','dolphin 12','dolphin 13',
  'dolphin 14','dolphin 15','dolphin 16'];
  
  var nationalAltCaption = ['national 1','national 2','national 3','national 4',
  'national 5','national 6','national 7','national 8','national 9','national 10',
  'national 11','national 12','national 13','national 14','national 15','national 16'];

  var carAltCaption = ['car 1','car 2','car 3','car 4','car 5','car 6','car 7',
  'car 8','car 9','car 10','car 11','car 12','car 13','car 14','car 15','car 16'];

   var godAltCaption = ['god 1','god 2','god 3','god 4','god 5','god 6',
   'god 7','god 8','god 9','god 10','god 11','god 12','god 13','god 14',
   'god 15','god 16'];

  var bikeAltCaption = ['bike 1','bike 2','bike 3','bike 4','bike 5','bike 6',
  'bike 7','bike 8','bike 9','bike 10','bike 11','bike 12','bike 13','bike 14',
  'bike 15','bike 16'];

  var modelAltCaption = ['model 1','model 2','model 3','model 4','model 5',
  ...
  document.getElementById('national_Gallery').onclick = function (){
    galleryType = 'national';
    thumbGen('national_images', nationalAltCaption);
  }
  document.getElementById('car_Gallery').onclick = function (){
    galleryType = 'car';
    thumbGen('car_images', carAltCaption);
  }
  document.getElementById('god_Gallery').onclick = function (){
    galleryType = 'god';
    thumbGen('god_images', godAltCaption);
  }
  document.getElementById('model_Gallery').onclick = function (){
    galleryType = 'model';
    thumbGen('model_images', modelAltCaption);
  }
 ...
 var allimages = document.images;
  ...
  var folderLarge = 'images/';
    ...
    }else if (galleryType == 'national') {
        folderLarge = 'national_images/'
    }else if (galleryType == 'car') {
        folderLarge = 'car_images/'
    }else if (galleryType == 'god') {
        folderLarge = 'god_images/'
    }else if (galleryType == 'model') {
        folderLarge = 'model_images/'
